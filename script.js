// Astrosynthetic — scroll-driven robot awakening + section activation
...
(function () {
  ...
  // If reduced motion is requested, freeze at a calm mid-state instead of 0.
  if (reduceMotion) {
    root.style.setProperty('--progress', '0.55');
